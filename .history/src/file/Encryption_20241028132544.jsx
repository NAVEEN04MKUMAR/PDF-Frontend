...
const [downloadUrlD, setDownloadUrlD] = useState('');
    ...
    const handleencrypt=async(e)=>{
      ...
      try{
        ...
        const res=await axios.post(`${apiUrl}/api/encrypt-pdf/`,formdata,{
...
const downloadURL = await getDownloadURL(storageRef);  // Use the original storageRef directly
    ...
    const handleDecrypt = async (fileUrl, secretkey, iv) => {
      ...
      const apiUrl = import.meta.env.VITE_BACKEND_URL;
    const decryptRes = await axios.post(`${apiUrl}/api/decrypt-pdf/`, {
      fileUrl: fileUrl,
